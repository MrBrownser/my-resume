    ...
    <>
      ...
      >
        <div className="relative px-4 py-3 rounded-full bg-zinc-800/80 backdrop-blur-md border border-zinc-700/50 shadow-lg">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-full blur opacity-50"></div>

          {isMobile ? (
            <div className="relative flex items-center justify-between">
              <Link href="/" className="font-bold text-lg">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-red-600">Mr</span>
                <span className="text-white">Brownser</span>
              </Link>
              <Button
                variant="ghost"
                size="icon"
            ...
            <div className="relative flex items-center gap-1">
              ...
              <Button
                size="sm"
                className="ml-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-red-500 hover:to-orange-500 border-0"
              >
                Resume
              </Button>
            </div>
      ...
      {isMobile && (
        ...
        >
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <Button className="mt-6 bg-gradient-to-r from-orange-500 to-red-500 hover:from-red-500 hover:to-orange-500 border-0">
              Resume
            </Button>
          </div>
        </motion.div>
